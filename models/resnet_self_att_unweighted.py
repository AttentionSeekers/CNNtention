...
# -*- coding: utf-8 -*-
"""
Created on 2024-12-08 11:57:22 Sunday
...
from models.attention.self_att_unweighted import SelfAtt
...
class ResnetSelfAtt(nn.Module):
    def __init__(
        ...
        self.att1 = SelfAtt(16)
        self.layer2 = self._make_layer(block, 32, layers[1], stride=2)
        self.att2 = SelfAtt(32)
        self.layer3 = self._make_layer(block, 64, layers[2], stride=2)
        self.att3 = SelfAtt(64)
